OmniauthPure::Application.configure do
  ...
  Rails.application.config.middleware.use OmniAuth::Builder do
    ...
    OpenID.fetcher.ca_file = "#{Rails.root}/config/ca-bundle.crt"
     ...
     provider :facebook, '385591618135959', 'e1b4c86b3026aea6cdf83850ffc33c30'
     provider :twitter, 'ymQEsL3jf7j43oYwwK9Q', 'SL3LfZEVacYTpe2XAUUBdHOjBhrW8gaGWWdfSDsM4TU'
     provider :github, '6b93c77e29bb14d07d6e', '32caf95dcc3164b7bc7318007b97c48a2dfcacd1'
